...
#include "arkanoid04/BallBound.h"
#ifdef _MSC_VER
#pragma warning (push)
...
// Cross Module References
	ARKANOID04_API UClass* Z_Construct_UClass_ABallBound_NoRegister();
	ARKANOID04_API UClass* Z_Construct_UClass_ABallBound();
...
// End Cross Module References
...
#endif
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_BoxCollisionBall_MetaData[];
#endif
		static const UE4CodeGen_Private::FObjectPropertyParams NewProp_BoxCollisionBall;
		static const UE4CodeGen_Private::FPropertyParamsBase* const PropPointers[];
...
#endif
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_ABallBound_Statics::NewProp_BoxCollisionBall_MetaData[] = {
		{ "Category", "BallBound" },
		{ "EditInline", "true" },
		{ "ModuleRelativePath", "BallBound.h" },
	};
#endif
	const UE4CodeGen_Private::FObjectPropertyParams Z_Construct_UClass_ABallBound_Statics::NewProp_BoxCollisionBall = { "BoxCollisionBall", nullptr, (EPropertyFlags)0x00200800000a001d, UE4CodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(ABallBound, BoxCollisionBall), Z_Construct_UClass_UBoxComponent_NoRegister, METADATA_PARAMS(Z_Construct_UClass_ABallBound_Statics::NewProp_BoxCollisionBall_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_ABallBound_Statics::NewProp_BoxCollisionBall_MetaData)) };
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_ABallBound_Statics::PropPointers[] = {
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_ABallBound_Statics::NewProp_BoxCollisionBall,
	};
	...
	IMPLEMENT_CLASS(ABallBound, 3910940339);
	template<> ARKANOID04_API UClass* StaticClass<ABallBound>()
	{
		return ABallBound::StaticClass();
	}
	static FCompiledInDefer Z_CompiledInDefer_UClass_ABallBound(Z_Construct_UClass_ABallBound, &ABallBound::StaticClass, TEXT("/Script/arkanoid04"), TEXT("ABallBound"), false, nullptr, nullptr, nullptr);
